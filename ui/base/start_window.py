...
class Ui_StartWindow(object):
    def setupUi(self, StartWindow):
        ...
        StartWindow.setStyleSheet("QPushButton{background:rgb(31, 44, 56);border-radius:3px;color:white;padding:4px;margin:4px;}QPushButton:hover{border:1px solid white;}QPushButton:pressed{color:black;background:white;}QScrollArea{border:2px solid rgb(31, 44, 56);border-radius:3px;}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 565, 420))
